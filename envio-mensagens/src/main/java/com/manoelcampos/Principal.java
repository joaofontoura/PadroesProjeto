...
import com.manoelcampos.message.MessageServiceEmail;
import com.manoelcampos.message.MessageServiceWhatsApp;
...
public class Principal {
    public static void main(String[] args) {
        ...
        final Newsletter newsletter = new Newsletter(customers, new MessageServiceEmail());
